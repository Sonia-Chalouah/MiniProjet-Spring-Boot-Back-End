...
/*
    ...
    */
    ...
    @GetMapping("/search/{numeroChambre}")
    public List<Chambre> searchChambreByNumeroChambre(@PathVariable Long numeroChambre) {
        return iChambreService.searchChambreByNumeroChambre(numeroChambre);
    }
